...
import { VerifyDiscordRequest, DiscordRequest } from "./utils/discord";
import { AxiosError } from "axios";
import util from "util";

const app = express();
app.use(
  express.json({ verify: VerifyDiscordRequest(process.env.D_PUBLIC_KEY || "") })
);

app.post("/interactions", function (req: Request, res: Response) {
